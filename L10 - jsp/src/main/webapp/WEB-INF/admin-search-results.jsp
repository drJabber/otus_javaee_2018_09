...
<c:if test="${!search.isEmpty()}">
    <display:table requestURI="displaytag.jsp" name="${search.find()}" decorator="rnk.l10.entities.decorators.StaffDisplayDecorator" sort="list" pagesize="10" class="display-search" >
