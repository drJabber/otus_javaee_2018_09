...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
        <footer class="footer-container" style="  background-image: url(${context_path}/static/img/bg-footer.png); ">
            <div class="b-footer">
                <div class="b-width-middle">
                    <div class="b-footer-inner">
                        <div class="b-footer-line"  style="  background-image: url(${context_path}/static/img/bg-foot-line.png); "></div>
                        <div class="b-footer-size">
