...
<jsp:useBean id="search" class="rnk.l14.entities.beans.StaffSearchBean" scope="session" />
<c:if test="${!search.isEmpty()}">
    <display:table requestURI="displaytag.jsp" name="${search.find(pageContext)}" decorator="rnk.l14.entities.decorators.StaffDisplayDecorator" sort="list" pagesize="6" class="display-search" >
